# E-065: Una enmienda del contrato posterior al paso 5 no reabre el trabajo ya entregado

**Área:** build
**Apariciones:** 3 — F-032 · F-035 · F-037 (ver la adenda del final)
...
En F-032, el contrato declaraba en su §2.1 que `refundCashRatio` tenía **dos** llamadores y exigía
...
## Adenda F-035 — la reintroduje justo después de evitarla, y en el otro extremo del pipeline

En F-035 el coordinador **evitó este error a propósito** entre el arquitecto y el paso 5: agrupó
...
## Adenda F-037 — la tercera, y la que enseña cómo se detecta sola

En F-037 el coordinador volvió a agrupar las enmiendas para evitar esta ficha, y esta vez cerró
