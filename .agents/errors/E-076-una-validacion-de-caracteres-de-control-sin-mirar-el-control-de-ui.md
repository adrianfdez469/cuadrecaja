# E-076: Una validación de caracteres de control adoptada sin mirar qué control de UI la alimenta
...
- El informe de seguridad exigía rechazar el rango `[\x00-\x1F\x7F-\x9F]` en el campo `motivo`,
  por consistencia con el control que el ADR 0120 adoptó tras la inyección ESC/POS de F-034.
...
0120 vale más que permitir saltos de línea en una nota de 300 caracteres, y una excepción en un
...
- **Mensaje propio** (`MOTIVO_CONTROL_CHARACTERS_MESSAGE`), sin editar
  `CONTROL_CHARACTERS_MESSAGE`: F-034 verificó criterios contra el texto de aquel, que además dice
