# E-064: El «antes» de un criterio lo destruye el propio paso que va a verificarlo

**Área:** tests
**Apariciones:** 1 — F-031 (detectado antes de ocurrir, no después)
...
Dos de los criterios de F-031 están redactados como comparaciones entre dos instantes:
...
Lo que se capturó en F-031, y que conviene copiar como lista:
...
ruido del propio endpoint. En F-031 los diez GET salieron idénticos y por eso la comparación
...
Corolario que se cumplió en F-031: cuando el «después» difiera del «antes», leer el criterio
