# E-067: Bytes de control literales en un documento rompen `grep` y sobreviven a un `Edit`
...
En F-032 el bloque afectado hubo que reescribirlo generándolo desde Python, porque una edición
...
Y un aviso de la misma familia, encontrado en F-032 al verificar: **`\x00` en un campo de texto lo
