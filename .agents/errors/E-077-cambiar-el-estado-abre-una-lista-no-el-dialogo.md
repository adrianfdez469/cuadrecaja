# E-077: «Cambiar el estado» abre una lista de estados, no el diálogo — y el script de QA lo lee como pantalla rota
...
escribe la verificación desde el contrato de diseño de F-036 —que habla del diálogo de entrega y
