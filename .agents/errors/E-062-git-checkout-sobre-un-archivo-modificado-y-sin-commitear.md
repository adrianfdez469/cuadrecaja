# E-062 — `git checkout --` sobre un archivo modificado y sin commitear

**Área:** build · **Veces:** 1 · **Aparecido en:** F-031 (paso 6, agente `qa`)
...
En F-031 el backlog pasó de **37 features a 28**: desaparecieron las nueve entradas del epic de
...
|---|---|---|
| F-029, F-030 (descripción y notas), F-032, F-037 | F-033 (descripción + 11 de sus criterios) | F-034, F-035, F-036 |
...
**El backlog está entero: 37 features otra vez.** F-034, F-035 y F-036 se recuperaron **verbatim**,
y también los dos criterios que le faltaban a F-033 —eran **trece**, no once—.
...
escrituras sobre `features.json`, y las tres tocaban solo F-029 y F-030. Las tres entradas
...
2. Los 11 criterios que F-033 ya tenía —recuperados en la primera pasada, **desde otra fuente**—
   coinciden verbatim con los 11 primeros de esta recuperación.
3. Los 13 criterios de F-033 aparecen literalmente en un volcado del archivo **anterior** al borrado.
4. El `notes` de F-036 aparece carácter a carácter, en su forma escapada, en otro volcado
...
Nadie se equivocó al implementar, ni al verificar: F-031 quedó **correctamente aprobado**, con sus
