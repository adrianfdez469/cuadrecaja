# E-064: Un símbolo nombrado dentro de `page.evaluate()` ejecutado con `tsx`

**Área:** tests
**Apariciones:** 1 — F-032 (QA)
...
No mordió a las verificaciones de F-029, F-030 ni F-031 por casualidad: allí los `evaluate` no
