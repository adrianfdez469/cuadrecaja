# E-067: Una `key` reutilizada mientras el nodo anterior todavía está saliendo

**Área:** ui
**Apariciones:** 2 — F-033 (detectado y **diferido**), F-034 (bloqueó un criterio)
...
[E-070](E-070-el-arreglo-del-bug-a-abre-el-camino-que-reabre-el-bug-b.md).
...
Y la lección de proceso, que costó la segunda aparición: **el `qa` de F-033 encontró este mismo
...
Detalle que confirma que aquí **leer no basta**: el `ui-designer` de F-034 leyó este mismo archivo
al escribir su contrato y concluyó que «el hallazgo de F-033 ya no se reproduce en el archivo
