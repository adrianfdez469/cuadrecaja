# E-079: `strict: false` colapsa el `| null` de zod y la clave sale **opcional**

**Área:** build
**Apariciones:** 1 — F-037 (paso 5, `IVentaCreditoEstadoInput.settledAt`)
...
En F-037 esto quedó como **consecuencia vinculante para todo el epic** (§ 0.6 (d) del contrato) y
con enmienda en el ADR 0134, precisamente para que el siguiente feature no vuelva a tropezar.
