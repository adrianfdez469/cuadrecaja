...
- `.agents/F-034-seguridad.md` completo, como precedente directo: el hallazgo H1 de ese informe
...
igual que M2 de `.agents/F-034-seguridad.md` señaló para un caso análogo.
...
señalado como deuda preexistente en M3 de `.agents/F-034-seguridad.md`), vale la pena que el
