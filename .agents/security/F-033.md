...
- `.agents/security/F-031.md` y `.agents/security/F-032.md` completos — para la forma del informe
...
`.agents/security/F-031.md` (B1, B2) y `.agents/security/F-032.md` (H1) ya señalaron para este
