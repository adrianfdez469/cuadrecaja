...
export const PROMOTER_STATUS_LABELS: Record<string, string> = {
  [PROMOTER_STATUS.active]: "Activo",
  [PROMOTER_STATUS.inactive]: "Inactivo",
  [PROMOTER_STATUS.pendingEmailVerification]: "Pendiente de verificar correo",
};
