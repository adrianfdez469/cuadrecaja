/**
 * The DOM anchors the acceptance criteria are verified against (E-011, ADR 0132).
 *
...
export const REPORTS_CREDIT_TEST_IDS = {
  ...
  /** The figure of the KPI that must NOT include credit (ADR 0139). */
...
/**
 * Every visible literal of this feature, fixed by `.agents/designs/F-039.md` § 0.1.
 ...
 * `CREDIT_COPY.closeDialogNotice` of F-036 already uses. `toFixed` is locale
