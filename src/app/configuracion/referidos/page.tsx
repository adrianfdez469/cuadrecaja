        ...
        {tab === 0 && (
          <Stack spacing={2}>
            ...
            {promoters.length === 0 && !loading && (
              <Alert severity="info">No hay promotores con los filtros actuales.</Alert>
            )}
          </Stack>
        )}
        ...
        {tab === 1 && (
          <Stack spacing={2}>
                    ...
                    <TableRow key={r.id}>
                      ...
                      <TableCell align="right">
                        ...
                        {r.status === REFERRAL_STATUS.liquidationPending && (
                          <Button size="small" variant="outlined" sx={{ ml: 1 }} onClick={() => openLiquidate(r)}>
                            Liquidar
                          </Button>
                        )}
                      </TableCell>
            ...
            {referrals.length === 0 && !loading && (
              <Alert severity="info">No hay referidos con los filtros actuales.</Alert>
            )}
          </Stack>
        )}
