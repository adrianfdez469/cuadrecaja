# ADR 0142: La copia commiteada del vector de precedencia se guarda como Markdown con su valla, no como JSON desnudo
...
El criterio 7 de F-041 pide que la copia local del vector de 13 casos se fije contra el sha256
...
Es decir, F-041 commitea dos ficheros con requisitos de salto de línea final **opuestos**, y los dos
...
- El fichero sigue siendo frágil a una conversión de fin de línea (CRLF), que sí entra en el grupo 1.
  Eso lo cubre el [ADR 0144](0144-gitattributes-fija-eol-lf-en-los-dos-ficheros-fijados-por-hash.md).
