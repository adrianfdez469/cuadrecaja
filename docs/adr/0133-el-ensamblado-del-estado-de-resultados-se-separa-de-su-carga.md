# ADR 0133: El ensamblado del estado de resultados se separa de su carga, para que «la ganancia es devengada» sea comprobable sin base de datos
...
[ADR 0123](0123-las-dos-cifras-de-flujo-entran-en-los-totales-almacenados.md) ·
...
exactamente su significado actual. F-037 añade al estado de resultados dos líneas informativas —lo
...
- Las dos cifras se **leen** de `CierrePeriodo.totalCreditoOtorgado` y `totalCobrosCredito`
  (ADR 0123, ya calculadas y persistidas por F-030), sumadas con **dos `_sum` más en el agregado que
...
- La extracción mueve código que ningún criterio de F-037 cubría antes. El riesgo se acota en que
