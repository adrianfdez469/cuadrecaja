# ADR 0119: El panel lee el saldo denormalizado, agrega en memoria y no pagina
...
`CuentaPorCobrar.saldoPendiente` es esa caché. Es lo que `loadSaldoPorCliente` (F-031) ya lee para
...
Lo que sostiene esta decisión es el ADR 0116: **toda escritura del libro pasa por
...
- Los tramos de antigüedad siguen teniendo **un** intérprete, y es el que F-029 declaró como tal.
