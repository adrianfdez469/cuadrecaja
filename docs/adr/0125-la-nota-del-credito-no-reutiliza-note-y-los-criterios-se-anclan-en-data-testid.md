# ADR 0125: La nota del crédito no reutiliza `note`, y los criterios se anclan en `data-testid`
...
Y no es solo esta celda: cuatro de los doce criterios de F-034 son afirmaciones sobre el DOM —«la
...
- La celda que la recibe es la de `label: "Total Venta"`, por concepto. **F-034 no la renombra**: si
...
- Los cuatro criterios de DOM de F-034 se vuelven verificables sin interpretar copy, y sobreviven a
