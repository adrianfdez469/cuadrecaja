# ADR 0144: Se estrena `.gitattributes` para fijar `eol=lf` en los dos ficheros cuyos bytes están clavados por un hash
...
[ADR 0143](0143-el-catalogo-de-zonas-vive-en-constants-y-su-hash-sale-del-disco.md)

## Contexto

F-041 commitea dos ficheros cuyo contenido está fijado byte a byte contra un sha256 publicado por el
contrato de QAB:
